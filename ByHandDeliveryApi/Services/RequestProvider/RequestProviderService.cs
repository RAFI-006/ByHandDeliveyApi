  ...
  public  class RequestProviderService 
    {
        ...
        public static async Task<TResult> PostDeliveryBoyAsync<TResult, Tin>(Uri uri, Tin data)
        {
            ...
            {
                HttpClient httpClient = CreateHttpClient();
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Authorization", deliveryServertoken);
